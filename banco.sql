...
--
-- Table structure for table `_system_errors`
--

DROP TABLE IF EXISTS `_system_errors`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `_system_errors` (
...
--
-- Dumping data for table `_system_errors`
--

LOCK TABLES `_system_errors` WRITE;
/*!40000 ALTER TABLE `_system_errors` DISABLE KEYS */;
/*!40000 ALTER TABLE `_system_errors` ENABLE KEYS */;
UNLOCK TABLES;
